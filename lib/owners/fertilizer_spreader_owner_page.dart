...
import '../users/fertilizer_spreader_owners_user_page.dart';
class User{
...
class FertilizerSpreaderOwnerPage extends StatefulWidget {
  const FertilizerSpreaderOwnerPage({Key? key}) : super(key: key);

  @override
  State<FertilizerSpreaderOwnerPage> createState() => _FertilizerSpreaderOwnerPageState();
}

class _FertilizerSpreaderOwnerPageState extends State<FertilizerSpreaderOwnerPage> {
  List<User> users = [
    const User(
            ...
            ListView.builder(
                ...
                itemBuilder:(context,index) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>FertilizerSpreaderOwnersUserPage(user:user,),));
                      },
                      child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  List<Widget>? buildActions(BuildContext context)=>[
    IconButton(
        ...
        onPressed: () {
          if (query.isEmpty) {
            close(context,FertilizerSpreaderOwnerPage());
          } else {
            query = '';
          }
        }
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,FertilizerSpreaderOwnerPage()),
  );
