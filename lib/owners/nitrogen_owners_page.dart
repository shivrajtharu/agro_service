...
import 'package:household/users/nitrogen_owners_users_page.dart';
...
class NitrogenOwnersPage extends StatefulWidget {
  const NitrogenOwnersPage({Key? key}) : super(key: key);

  @override
  State<NitrogenOwnersPage> createState() => _NitrogenOwnersPageState();
}

class _NitrogenOwnersPageState extends State<NitrogenOwnersPage> {
  List<User> users = [
    const User(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Nitrogen Owners",style: TextStyle(fontWeight: FontWeight.bold)
          ),
          centerTitle: true,
            ...
            ListView.builder(
                ...
                itemBuilder:(context,index) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>NitrogenOwnersUsersPage(user:user,),));
                      },
                      child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  List<Widget>? buildActions(BuildContext context)=>[
    IconButton(
        ...
        onPressed: () {
          if (query.isEmpty) {
            close(context, NitrogenOwnersPage());
          } else {
            query = '';
          }
        }
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,NitrogenOwnersPage()),
  );
