...
import '../users/combine_harvester_owner_user_page.dart';
class User{
...
class CombineHarvesterOwnerPage extends StatefulWidget {
  const CombineHarvesterOwnerPage({Key? key}) : super(key: key);

  @override
  State<CombineHarvesterOwnerPage> createState() => _CombineHarvesterOwnerPageState();
}

class _CombineHarvesterOwnerPageState extends State<CombineHarvesterOwnerPage> {
  List<User> users = [
    const User(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Harvester Owners",style: TextStyle(fontWeight: FontWeight.bold)
          ),
          centerTitle: true,
            ...
            ListView.builder(
                ...
                itemBuilder:(context,index) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>CombineHarvesterOwnerUserPage(user:user,),));
                      },
                      child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  List<Widget>? buildActions(BuildContext context)=>[
    IconButton(
        ...
        onPressed: () {
          if (query.isEmpty) {
            close(context, CombineHarvesterOwnerPage());
          } else {
            query = '';
          }
        }
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,CombineHarvesterOwnerPage()),
  );
