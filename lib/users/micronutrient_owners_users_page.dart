...
import 'package:household/fertilizers/micronutrient_details_page.dart';
import '../Report.dart';
...
class MicronutrientOwnersUsersPage extends StatelessWidget {
  final user;
  const MicronutrientOwnersUsersPage({Key? key, required this.user}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(onPressed:() {
                      Navigator.push(context, MaterialPageRoute(builder: (
                          context) => MicronutrientDetailsPage()));
                    },
                      icon: Icon(
