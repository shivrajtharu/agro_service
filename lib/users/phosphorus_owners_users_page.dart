...
import 'package:household/fertilizers/phosphorous_details_page.dart';
import '../Report.dart';
...
class PhosphorusOwnersUsersPage extends StatelessWidget {
  final user;
  const PhosphorusOwnersUsersPage({Key? key, required this. user}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(onPressed:() {
                      Navigator.push(context, MaterialPageRoute(builder: (
                          context) => PhosphorousDetailsPage()));
                    },
                      icon: Icon(
