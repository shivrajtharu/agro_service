...
import 'package:household/machines/trailers_details_page.dart';
import '../Report.dart';
...
class TrailersOwnersUsersPage extends StatelessWidget {
  final user;
  const TrailersOwnersUsersPage({Key? key, required this.user}) : super(key: key);
