...
import '../machines/combine_harvester_details_page.dart';
...
class CombineHarvesterOwnerUserPage extends StatelessWidget {
  final user;
  const CombineHarvesterOwnerUserPage({Key? key, required this.user}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(onPressed:() {
                      Navigator.push(context, MaterialPageRoute(builder: (
                          context) => CombineHarvesterDetailsPage()));
                    },
                      icon: Icon(
