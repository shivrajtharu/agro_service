...
import 'package:household/fertilizers/magnesium_details_page.dart';
import '../Report.dart';
...
class MagnesiumOwnersUsersPage extends StatelessWidget {
  final user;
  const MagnesiumOwnersUsersPage({Key? key, required this. user}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(onPressed:() {
                      Navigator.push(context, MaterialPageRoute(builder: (
                          context) => MagnesiumOwnersDetailsPage()));
                    },
                      icon: Icon(
