...
import 'package:household/fertilizers/potassium_details_page.dart';
...
class PotassiumOwnersUsersPage extends StatelessWidget {
  final user;
  const PotassiumOwnersUsersPage({Key? key, required this. user}) : super(key: key);
