...
import 'package:household/fertilizers/sulphur_details_page.dart';
import '../report.dart';
...
class SulphurOwnersUsersPage extends StatelessWidget {
  final user;
  const SulphurOwnersUsersPage({Key? key, required this. user}) : super(key: key);
