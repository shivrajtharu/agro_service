...
import 'package:household/machines/agricultural_tools_details_page.dart';
import '../report.dart';
...
class AgriculturalToolsOwnersUsersPage extends StatelessWidget {
  final user;
  const AgriculturalToolsOwnersUsersPage({Key? key, required this.user}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(onPressed:() {
                      Navigator.push(context, MaterialPageRoute(builder: (
                          context) => AgriculturalToolsDetailsPage()));
                    },
                      icon: Icon(
