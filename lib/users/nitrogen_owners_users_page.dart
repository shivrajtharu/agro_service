...
import 'package:household/fertilizers/nitrogen_details_page.dart';
import '../Report.dart';
...
class NitrogenOwnersUsersPage extends StatelessWidget {
  final user;
  const NitrogenOwnersUsersPage({Key? key, required this. user}) : super(key: key);
