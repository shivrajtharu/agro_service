...
import 'package:household/machines/fertilizer_spreader_details_page.dart';
import '../Report.dart';
...
class FertilizerSpreaderOwnersUserPage extends StatelessWidget {
  final user;
  const FertilizerSpreaderOwnersUserPage({Key? key, required this. user}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(onPressed:() {
                      Navigator.push(context, MaterialPageRoute(builder: (
                          context) => FertilizerSpreaderDetailsPage()));
                    },
                      icon: Icon(
