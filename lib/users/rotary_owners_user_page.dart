...
import 'package:household/machines/rotary_details_page.dart';
import '../report.dart';
...
class RotaryOwnersUserPage extends StatelessWidget {
  final user;
  const RotaryOwnersUserPage({Key? key, required this.user}) : super(key: key);
