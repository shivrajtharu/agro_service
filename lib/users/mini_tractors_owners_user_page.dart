...
import '../machines/mini_tractor_details_page.dart';
import '../Report.dart';
...
class MiniTractorsOwnersUserPage extends StatelessWidget {
  final user;
  const MiniTractorsOwnersUserPage({Key? key, required this.user}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(onPressed:() {
                      Navigator.push(context, MaterialPageRoute(builder: (
                          context) => MiniTractorDetailsPage()));
                    },
                      icon: Icon(
