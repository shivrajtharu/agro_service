...
import 'package:household/machines/seeders_details_page.dart';
import '../Report.dart';
...
class SeedersOwnersUserPage extends StatelessWidget {
  final user;
  const SeedersOwnersUserPage({Key? key, required this.user}) : super(key: key);
