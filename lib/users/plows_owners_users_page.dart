...
import 'package:household/machines/plows_details_page.dart';
import '../Report.dart';
...
class PlowsOwnersUserPage extends StatelessWidget {
  final user;
  const PlowsOwnersUserPage({Key? key, required this.user}) : super(key: key);
