...
class PhosphorousDetailsPage extends StatelessWidget {
  const PhosphorousDetailsPage({Key? key}) : super(key: key);
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: AssetImage('assets/images/phosphorus.png',),
                                ),
                                borderRadius: BorderRadius.only(
                                  topRight: Radius.circular(10),
                                  bottomRight: Radius.circular(10),
                        ...
                        child: Column(
                          children: [
                            _bottomContainer(
                                ...
                                images: 'assets/images/phosphorus2.png'
                            ),
                          ],
                        ),
