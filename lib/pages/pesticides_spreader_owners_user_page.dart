...
import 'package:household/pages/pesticides_spreader_details_page.dart';
...
class PesticidesSpreaderOwnersUserPage extends StatelessWidget {
  final user;
  const PesticidesSpreaderOwnersUserPage({Key? key, required this.user}) : super(key: key);
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(onPressed:() {
                      Navigator.push(context, MaterialPageRoute(builder: (
                          context) => PesticideSpreaderDetailsPage()));
                    },
                      icon: Icon(
