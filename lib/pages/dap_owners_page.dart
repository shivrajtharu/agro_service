...
import 'package:household/pages/dap_owners_user_page.dart';
...
class DapOwnersPage extends StatefulWidget {
  const DapOwnersPage({Key? key}) : super(key: key);

  @override
  State<DapOwnersPage> createState() => _DapOwnersPageState();
}

class _DapOwnersPageState extends State<DapOwnersPage> {
  List<User> users = [
    const User(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: AppBar(
          title: Text("DAP Owners",style: TextStyle(fontWeight: FontWeight.bold)
          ),
          centerTitle: true,
            ...
            ListView.builder(
                ...
                itemBuilder:(context,index) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>DapOwnersUsersPage(user:user,),));
                      },
                      child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,DapOwnersPage()),
  );
