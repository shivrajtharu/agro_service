...
import 'package:household/pages/mini_tractors_owners_user_page.dart';
...
class MiniTractorsOwnersPage extends StatefulWidget {
  const MiniTractorsOwnersPage({Key? key}) : super(key: key);

  @override
  State<MiniTractorsOwnersPage> createState() => _MiniTractorsOwnersPageState();
}

class _MiniTractorsOwnersPageState extends State<MiniTractorsOwnersPage> {
  List<User> users = [
    const User(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Mini Tractor Owners",style: TextStyle(fontWeight: FontWeight.bold)
          ),
          centerTitle: true,
            ...
            ListView.builder(
                ...
                itemBuilder:(context,index) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>MiniTractorsOwnersUserPage(user:user),));
                      },
                      child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  List<Widget>? buildActions(BuildContext context)=>[
    IconButton(
        ...
        onPressed: () {
          if (query.isEmpty) {
            close(context, MiniTractorsOwnersPage());
          } else {
            query = '';
          }
        }
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,MiniTractorsOwnersPage()),
  );
