...
import 'package:household/pages/urea_details_page.dart';
...
class UreaOwnersUsersPage extends StatelessWidget {
  final user;
  const UreaOwnersUsersPage({Key? key, required this. user}) : super(key: key);
