    ...
    return Container(
        ...
        child: Scaffold(
            ...
            appBar: AppBar(
                ...
                title: Text('Plots',style: TextStyle(fontWeight: FontWeight.bold)),
                centerTitle: true,
            ...
            body: Stack(
              children: [
                Container(
                    child: Center(child: Text("Plots Page",style: TextStyle(color: Colors.amber,fontSize: 35,fontWeight:FontWeight.bold),
                    ),)
                ),
              ],
            )
