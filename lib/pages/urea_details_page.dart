...
class UreaDetailsPage extends StatelessWidget {
  const UreaDetailsPage({Key? key}) : super(key: key);
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: AssetImage('assets/images/urea_title.png',),
                                ),
                                borderRadius: BorderRadius.only(
                                  topRight: Radius.circular(10),
                                  bottomRight: Radius.circular(10),
