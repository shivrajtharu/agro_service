...
import 'package:household/pages/Report_page.dart';
import 'package:household/pages/follow_page.dart';
import 'package:household/pages/tractors_details_page.dart';
...
class TractorOwnersUserPage extends StatelessWidget {
  final user;
  const TractorOwnersUserPage({Key? key, required this.user}) : super(key: key);
