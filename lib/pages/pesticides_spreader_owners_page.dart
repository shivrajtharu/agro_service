...
import 'package:household/pages/pesticides_spreader_owners_user_page.dart';
...
class PesticidesSpreaderOwnersPage extends StatefulWidget {
  const PesticidesSpreaderOwnersPage({Key? key}) : super(key: key);

  @override
  State<PesticidesSpreaderOwnersPage> createState() => _PesticidesSpreaderOwnersPageState();
}

class _PesticidesSpreaderOwnersPageState extends State<PesticidesSpreaderOwnersPage> {
  List<User> users = [
  const User(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Owners",style: TextStyle(fontWeight: FontWeight.bold)
          ),
          centerTitle: true,
            ...
            ListView.builder(
                ...
                itemBuilder:(context,index) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>PesticidesSpreaderOwnersUserPage(user:user,),));
                      },
                      child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  List<Widget>? buildActions(BuildContext context)=>[
    IconButton(
        ...
        onPressed: () {
          if (query.isEmpty) {
            close(context,PesticidesSpreaderOwnersPage());
          } else {
            query = '';
          }
        }
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,PesticidesSpreaderOwnersPage()),
  );
