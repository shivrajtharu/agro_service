...
import 'package:household/pages/urea_owners_user_page.dart';
...
class UreaOwnersPage extends StatefulWidget {
  const UreaOwnersPage({Key? key}) : super(key: key);

  @override
  State<UreaOwnersPage> createState() => _UreaOwnersPageState();
}

class _UreaOwnersPageState extends State<UreaOwnersPage> {
  List<User> users = [
    const User(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Urea Owners",style: TextStyle(fontWeight: FontWeight.bold)
          ),
          centerTitle: true,
            ...
            ListView.builder(
                ...
                itemBuilder:(context,index) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>UreaOwnersUsersPage(user:user,),));
                      },
                      child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,UreaOwnersPage()),
  );
