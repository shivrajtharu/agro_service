...
import 'package:household/pages/pump_sets_owners_user_page.dart';
...
class PumpSetsOwnersPage extends StatefulWidget {
  const PumpSetsOwnersPage({Key? key}) : super(key: key);

  @override
  State<PumpSetsOwnersPage> createState() => _PumpSetsOwnersPageState();
}

class _PumpSetsOwnersPageState extends State<PumpSetsOwnersPage> {
  List<User> users = [
    const User(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Pumpsets Owners",style: TextStyle(fontWeight: FontWeight.bold)
          ),
          centerTitle: true,
            ...
            ListView.builder(
                ...
                itemBuilder:(context,index) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>PumpSetsOwnersUserPage(user:user,),));
                      },
                      child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  List<Widget>? buildActions(BuildContext context)=>[
    IconButton(
        ...
        onPressed: () {
          if (query.isEmpty) {
            close(context, PumpSetsOwnersPage());
          } else {
            query = '';
          }
        }
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,PumpSetsOwnersPage()),
  );
