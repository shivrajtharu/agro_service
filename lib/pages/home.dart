...
import 'package:household/pages/plots_owners_page.dart';
...
import 'package:household/pages/farmers_page.dart';
import 'package:household/ui/login_page.dart';
import 'machine_types_page.dart';
...
class WorkerSearchDelegate extends SearchDelegate{
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,FarmersPage()),
  );
