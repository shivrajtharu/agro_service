...
import 'package:household/pages/fertilizers_owners_user_page.dart';
...
class FertilizersOwnersPage extends StatefulWidget {
  const FertilizersOwnersPage({Key? key}) : super(key: key);

  @override
  State<FertilizersOwnersPage> createState() => _FertilizersOwnersPageState();
}

class _FertilizersOwnersPageState extends State<FertilizersOwnersPage> {
  List<User> users = [
    const User(
          ...
          ListView.builder(
              ...
              itemBuilder:(context,index) {
                ...
                return Card(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(builder: (context)=>FertilizersOwnersUsersPage(user:user,),));
                    },
                    child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  List<Widget>? buildActions(BuildContext context)=>[
    IconButton(
        ...
        onPressed: () {
          if (query.isEmpty) {
            close(context,FertilizersOwnersPage());
          } else {
            query = '';
          }
        }
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,FertilizersOwnersPage()),
  );
