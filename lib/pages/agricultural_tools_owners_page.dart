...
import 'package:household/pages/agricultural_tools_owners_user_page.dart';
...
class AgriculturalToolsOwnersPage extends StatefulWidget {
  const AgriculturalToolsOwnersPage({Key? key}) : super(key: key);

  @override
  State<AgriculturalToolsOwnersPage> createState() => _AgriculturalToolsOwnersPageState();
}

class _AgriculturalToolsOwnersPageState extends State<AgriculturalToolsOwnersPage> {
  List<User> users = [
    const User(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Tools Owners",style: TextStyle(fontWeight: FontWeight.bold)
          ),
          centerTitle: true,
            ...
            ListView.builder(
                ...
                itemBuilder:(context,index) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>AgriculturalToolsOwnersUsersPage(user:user,),));
                      },
                      child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  List<Widget>? buildActions(BuildContext context)=>[
    IconButton(
        ...
        onPressed: () {
          if (query.isEmpty) {
            close(context, AgriculturalToolsOwnersPage());
          } else {
            query = '';
          }
        }
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,AgriculturalToolsOwnersPage()),
  );
