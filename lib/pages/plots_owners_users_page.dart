...
import 'package:household/pages/plots_details_page.dart';
...
class PlotsOwnersUserPage extends StatelessWidget {
  final user;
  const PlotsOwnersUserPage({Key? key, required this.user}) : super(key: key);
