...
import 'package:household/pages/organic_details_page.dart';
...
class OrganicOwnersUsersPage extends StatelessWidget {
  final user;
  const OrganicOwnersUsersPage({Key? key, this.user}) : super(key: key);
