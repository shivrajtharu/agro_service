...
import 'package:household/pages/sulphur_owners_users_page.dart';
...
class SulphurOwnersPage extends StatefulWidget {
  const SulphurOwnersPage({Key? key}) : super(key: key);

  @override
  State<SulphurOwnersPage> createState() => _SulphurOwnersPageState();
}

class _SulphurOwnersPageState extends State<SulphurOwnersPage> {
  List<User> users = [
    const User(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Sulphur Owners",style: TextStyle(fontWeight: FontWeight.bold)
          ),
          centerTitle: true,
            ...
            ListView.builder(
                ...
                itemBuilder:(context,index) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>SulphurOwnersUsersPage(user:user,),));
                      },
                      child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  List<Widget>? buildActions(BuildContext context)=>[
    IconButton(
        ...
        onPressed: () {
          if (query.isEmpty) {
            close(context, SulphurOwnersPage());
          } else {
            query = '';
          }
        }
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,SulphurOwnersPage()),
  );
