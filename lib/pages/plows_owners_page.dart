...
import 'package:household/pages/plows_owners_users_page.dart';
...
class PlowsOwnersPage extends StatefulWidget {
  const PlowsOwnersPage({Key? key}) : super(key: key);

  @override
  State<PlowsOwnersPage> createState() => _PlowsOwnersPageState();
}

class _PlowsOwnersPageState extends State<PlowsOwnersPage> {
  List<User> users = [
    const User(
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: AppBar(
          title: Text("Plows Owners",style: TextStyle(fontWeight: FontWeight.bold)
          ),
          centerTitle: true,
            ...
            ListView.builder(
                ...
                itemBuilder:(context,index) {
                  ...
                  return Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=>PlowsOwnersUserPage(user:user,),));
                      },
                      child: ListTile(
...
class MYSearchDelegate extends SearchDelegate{
  ...
  Widget? buildLeading(BuildContext context)=>IconButton(
    ...
    onPressed: ()=>close(context,PlowsOwnersPage()),
  );
