...
class PlotRegisterPage extends StatefulWidget {
  const PlotRegisterPage({Key? key}) : super(key: key);
...
class _PlotRegisterPageState extends State<PlotRegisterPage> {
  ...
  void registerPlot() async{
    var url="http://localhost:8000/home/plot/register";
    var data={
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text("Plot Account",style: TextStyle(fontWeight: FontWeight.bold)),
          centerTitle: true,
