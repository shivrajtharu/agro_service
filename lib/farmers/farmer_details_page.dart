...
class FarmerDetails extends StatelessWidget {
  final Datum farmerData;
  final _formKey = GlobalKey<FormState>();
  final _nameController = TextEditingController();
  final _itemController = TextEditingController();
  final _addressController = TextEditingController();
  final _contactController = TextEditingController();
  FarmerDetails({required this.farmerData});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(farmerData.fullname),
            ...
            Column(
              children: [
                Center(
                  child: CircleAvatar(
                    radius: 60,
                    child: Text(getUserCharacter(farmerData.fullname),
                        style: TextStyle(
                            fontSize: 30,
                            color: Colors.white
                        )),
                ...
                SizedBox(height: 10),
                Text(
                  '${farmerData.active_status ? 'Active' : 'Inactive'}',
                  style: TextStyle(fontSize: 16),
                ),
              ],
            ),
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Container(
                                      child: Column(
                                        children: [
                                          Text('Irrigating',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                    ...
                                    Container(
                                      child: Column(
                                        children: [
                                          Column(
                                            children: [
                                              Text('Harvesting',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                              Text('daily,Rs.500\nhourly,Rs.100',style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold),),
                                              ElevatedButton(onPressed: (){
                                                showDialog(
                                                  context: context,
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Container(
                                      child: Column(
                                        children: [
                                          Text('Caring',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                          Text('daily,Rs.500\nhourly,Rs.100',style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold),),
                                          ElevatedButton(onPressed: (){
                                            showDialog(
                                              context: context,
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Container(
                                      child: Column(
                                        children: [
                                          Text('Planting',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
                                          Text('daily,Rs.500\nhourly,Rs.100',style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold),),
                                          ElevatedButton(
                                              onPressed: (){
                                                showDialog(
